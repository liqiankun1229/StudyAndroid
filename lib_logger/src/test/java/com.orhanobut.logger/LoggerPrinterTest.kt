...
class LoggerPrinterTest {
  ...
  @Test fun logErrorWithThrowable() {
    ...
    verify(adapter).log(eq(ERROR), isNull(), contains("message sent : java.lang.Throwable: exception"))
  }
  ...
  @Test fun logWithOnlyThrowableWithoutMessage() {
    ...
    verify(adapter).log(eq(DEBUG), isNull(), contains("java.lang.Throwable: exception"))
  }
}