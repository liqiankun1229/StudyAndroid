...
import com.lqk.butter.zxing.core.oned.Code128Reader;
...
public final class Code128Writer extends OneDimensionalCodeWriter {
  ...
  public boolean[] encode(String contents) {
    ...
    while (position < length) {
      ...
      // Get the pattern
      patterns.add(com.lqk.butter.zxing.core.oned.Code128Reader.CODE_PATTERNS[patternIndex]);
    ...
    checkSum %= 103;
    patterns.add(com.lqk.butter.zxing.core.oned.Code128Reader.CODE_PATTERNS[checkSum]);
