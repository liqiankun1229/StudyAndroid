...
import com.lqk.butter.zxing.core.oned.Code39Reader;
...
public final class Code39Writer extends OneDimensionalCodeWriter {
  ...
  public boolean[] encode(String contents) {
    ...
    for (int i = 0; i < length; i++) {
      int indexInString = com.lqk.butter.zxing.core.oned.Code39Reader.ALPHABET_STRING.indexOf(contents.charAt(i));
      if (indexInString < 0) {
    ...
    for (int i = 0; i < length; i++) {
      int indexInString = com.lqk.butter.zxing.core.oned.Code39Reader.ALPHABET_STRING.indexOf(contents.charAt(i));
      toIntArray(com.lqk.butter.zxing.core.oned.Code39Reader.CHARACTER_ENCODINGS[indexInString], widths);
      for (int width : widths) {
        codeWidth += width;
      }
    }
    boolean[] result = new boolean[codeWidth];
    toIntArray(com.lqk.butter.zxing.core.oned.Code39Reader.ASTERISK_ENCODING, widths);
