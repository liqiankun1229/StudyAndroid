...
package com.lqk.butter.zxing.history;
...
final class HistoryItemAdapter extends ArrayAdapter<HistoryItem> {
    ...
    HistoryItemAdapter(Context activity) {
        super(activity, R.layout.item_history_list, new ArrayList<HistoryItem>());
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view instanceof LinearLayout) {
            ...
            layout = factory.inflate(R.layout.item_history_list, viewGroup, false);
        }
