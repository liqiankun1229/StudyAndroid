...
final class SimpleToken extends com.lqk.butter.zxing.core.aztec.encoder.Token {

  // For normal words, indicates value and bitCount
  private final short value;
  private final short bitCount;

  SimpleToken(com.lqk.butter.zxing.core.aztec.encoder.Token previous, int value, int bitCount) {
    super(previous);
