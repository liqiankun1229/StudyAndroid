...
import com.lqk.butter.zxing.core.client.result.TelParsedResult;
...
public final class TelResultHandler extends ResultHandler {
    ...
    public void handleButtonPress(int index) {
        ...
        switch (index) {
            case 0:
                ...
                // but app can't get permissionCamera in this state. Avoid issues by just quitting, only in the
                // case of a permissionCallPhone number
                getActivity().finish();
                break;
            case 1:
    ...
    // Overriden so we can take advantage of Android's permissionCallPhone number hyphenation routines.
    @Override
