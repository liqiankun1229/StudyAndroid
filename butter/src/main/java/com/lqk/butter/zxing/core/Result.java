...
public final class Result {
  ...
  private final com.lqk.butter.zxing.core.BarcodeFormat format;
  ...
  /**
   * @return {@link com.lqk.butter.zxing.core.BarcodeFormat} representing the format of the barcode that was decoded
   */
