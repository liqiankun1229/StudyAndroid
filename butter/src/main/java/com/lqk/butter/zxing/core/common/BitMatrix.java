...
package com.lqk.butter.zxing.core.common;
...
public final class BitMatrix implements Cloneable {
    ...
    public void xor(BitMatrix mask) {
        ...
        com.lqk.butter.zxing.core.common.BitArray rowArray = new com.lqk.butter.zxing.core.common.BitArray(width);
     ...
     * your own row
     */
    public com.lqk.butter.zxing.core.common.BitArray getRow(int y, com.lqk.butter.zxing.core.common.BitArray row) {
        if (row == null || row.getSize() < width) {
            row = new com.lqk.butter.zxing.core.common.BitArray(width);
        } else {
            row.clear();
        }
        int offset = y * rowSize;
    ...
    /**
     * @param y   row to set
     * @param row {@link com.lqk.butter.zxing.core.common.BitArray} to copy from
     */
    public void setRow(int y, com.lqk.butter.zxing.core.common.BitArray row) {
    ...
    public void rotate180() {
        ...
        com.lqk.butter.zxing.core.common.BitArray topRow = new com.lqk.butter.zxing.core.common.BitArray(width);
        com.lqk.butter.zxing.core.common.BitArray bottomRow = new BitArray(width);
