...
public final class EmailAddressResultParser extends ResultParser {
  ...
  @Override
  public com.lqk.butter.zxing.core.client.result.EmailAddressParsedResult parse(Result result) {
    ...
    if (rawText.startsWith("mailto:") || rawText.startsWith("MAILTO:")) {
      ...
      return new com.lqk.butter.zxing.core.client.result.EmailAddressParsedResult(tos, ccs, bccs, subject, body);
    } else {
