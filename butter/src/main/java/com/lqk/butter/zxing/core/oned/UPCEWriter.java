...
import com.lqk.butter.zxing.core.oned.UPCEANWriter;
  ...
  public boolean[] encode(String contents) {
    ...
    switch (length) {
      case 7:
        ...
        int check;
        try {
          check = UPCEANReader.getStandardUPCEANChecksum(com.lqk.butter.zxing.core.oned.UPCEReader.convertUPCEtoUPCA(contents));
