...
package com.lqk.butter.zxing.core.pdf417.encoder;

import com.lqk.butter.zxing.core.pdf417.encoder.BarcodeRow;
...
public final class BarcodeMatrix {
  ...
  private final com.lqk.butter.zxing.core.pdf417.encoder.BarcodeRow[] matrix;
  ...
  BarcodeMatrix(int height, int width) {
    matrix = new com.lqk.butter.zxing.core.pdf417.encoder.BarcodeRow[height];
    //Initializes the array to the correct width
    for (int i = 0, matrixLength = matrix.length; i < matrixLength; i++) {
      matrix[i] = new com.lqk.butter.zxing.core.pdf417.encoder.BarcodeRow((width + 4) * 17 + 1);
    }
    this.width = width * 17;
    this.height = height;
    this.currentRow = -1;
  ...
  com.lqk.butter.zxing.core.pdf417.encoder.BarcodeRow getCurrentRow() {
