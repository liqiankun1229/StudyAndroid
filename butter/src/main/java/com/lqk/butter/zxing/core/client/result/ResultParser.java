...
package com.lqk.butter.zxing.core.client.result;
...
public abstract class ResultParser {
   ...
   * of information (email, URL, etc.) and return a {@link com.lqk.butter.zxing.core.client.result.ParsedResult} encapsulating
   * the result of parsing.
   *
   * @param theResult the raw {@link Result} to parse
   * @return {@link com.lqk.butter.zxing.core.client.result.ParsedResult} encapsulating the parsing result
   */
  public abstract com.lqk.butter.zxing.core.client.result.ParsedResult parse(Result theResult);
  ...
  public static com.lqk.butter.zxing.core.client.result.ParsedResult parseResult(Result theResult) {
