...
public final class Intents {
    ...
    public static final class Scan {
         ...
         * the results.
         */
        public static final String ACTION = "com.lqk.butter.zxing.core.client.android.SCAN";
         ...
         * {@link com.lqk.butter.zxing.core.BarcodeFormat}s, e.g. {@link com.lqk.butter.zxing.core.BarcodeFormat#EAN_13}.
         * Example: "EAN_13,EAN_8,QR_CODE". This overrides {@link #MODE}.
         */
        public static final String FORMATS = "SCAN_FORMATS";

        /**
         * Optional parameter to specify the id of the permissionCamera from which to recognize barcodes.
         * Overrides the default permissionCamera that would otherwise would have been selected.
         * If provided, should be an int.
         */
        public static final String CAMERA_ID = "SCAN_CAMERA_ID";

        /**
         * @see com.lqk.butter.zxing.core.DecodeHintType#CHARACTER_SET
         */
         ...
         * See {@link com.lqk.butter.zxing.core.BarcodeFormat} for possible values.
         */
         ...
         * to {@link com.lqk.butter.zxing.core.BarcodeFormat#UPC_A} and {@link com.lqk.butter.zxing.core.BarcodeFormat#EAN_13}
         * formats.
         */
        ...
        /**
         * Key for the value of {@link com.lqk.butter.zxing.core.ResultMetadataType#ORIENTATION}, if available.
         * Call {@link Intent#getIntArrayExtra(String)} with {@code RESULT_ORIENTATION}.
         */
        public static final String RESULT_ORIENTATION = "SCAN_RESULT_ORIENTATION";

        /**
         * Key for the value of {@link com.lqk.butter.zxing.core.ResultMetadataType#ERROR_CORRECTION_LEVEL}, if available.
         * Call {@link Intent#getStringExtra(String)} with {@code RESULT_ERROR_CORRECTION_LEVEL}.
         */
        public static final String RESULT_ERROR_CORRECTION_LEVEL = "SCAN_RESULT_ERROR_CORRECTION_LEVEL";

        /**
         * Prefix for keys that map to the values of {@link com.lqk.butter.zxing.core.ResultMetadataType#BYTE_SEGMENTS},
    ...
    public static final class Encode {
         ...
         */
        public static final String ACTION = "com.lqk.butter.zxing.core.client.android.ENCODE";
         ...
         * format is one of {@link com.lqk.butter.zxing.core.BarcodeFormat}.
         */
    ...
    public static final class SearchBookContents {
         ...
         */
        public static final String ACTION = "com.lqk.butter.zxing.core.client.android.SEARCH_BOOK_CONTENTS";
    ...
    public static final class WifiConnect {
         ...
         */
        public static final String ACTION = "com.lqk.butter.zxing.core.client.android.WIFI_CONNECT";
    ...
    public static final class Share {
         ...
         * display onscreen for a friend to scan with their permissionCallPhone.
         */
        public static final String ACTION = "com.lqk.butter.zxing.core.client.android.SHARE";
