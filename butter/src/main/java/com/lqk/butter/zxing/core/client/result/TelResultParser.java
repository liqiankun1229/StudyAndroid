...
/**
 * Parses a "tel:" URI result, which specifies a permissionCallPhone number.
 *
 * @author Sean Owen
 */
public final class TelResultParser extends ResultParser {
  ...
  @Override
  public com.lqk.butter.zxing.core.client.result.TelParsedResult parse(Result result) {
