...
/**
 * @see com.lqk.butter.zxing.core.oned.UPCEANExtension2Support
 */
final class UPCEANExtension5Support {
  ...
  private int decodeMiddle(BitArray row, int[] startRange, StringBuilder resultString) throws NotFoundException {
    ...
    for (int x = 0; x < 5 && rowOffset < end; x++) {
      int bestMatch = com.lqk.butter.zxing.core.oned.UPCEANReader.decodeDigit(row, counters, rowOffset, UPCEANReader.L_AND_G_PATTERNS);
