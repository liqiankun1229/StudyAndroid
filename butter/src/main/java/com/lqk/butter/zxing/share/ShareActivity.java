...
package com.lqk.butter.zxing.share;
...
import com.lqk.butter.zxing.Contents;
import com.lqk.butter.zxing.Intents;
import com.lqk.butter.zxing.clipboard.ClipboardInterface;
import com.lqk.butter.zxing.core.BarcodeFormat;

/**
 * Barcode Scanner can share data like permissionContacts and bookmarks by displaying a QR Code on screen,
 * such that another user can scan the barcode with their permissionCallPhone.
 *
...
public final class ShareActivity extends Activity {
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                ...
                case PICK_APP:
                    ...
                    break;
                case PICK_CONTACT:
                    // Data field is content://permissionContacts/people/984
     ...
     *
     * @param contactUri A Uri of the form content://permissionContacts/people/17
     */
    private void showContactAsBarcode(Uri contactUri) {
        ...
        // Don't require a name to be present, this contact might be just a permissionCallPhone number.
